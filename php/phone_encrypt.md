...
> 出于隐私和数据保护的目的,有些项目需要对手机号进行加密.最近手头上正好有一个这样的项目,就简单的想了一个加密的规则,可以再次修改提升复杂度,初步的版本暂时如下

git地址: <https://gitee.com/justwkj/code-snippet/blob/master/php/phoneEncrypt.php>  
代码如下:
```php
<?php
/**
